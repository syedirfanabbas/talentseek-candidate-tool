...
test('return destinations preserve supported paths, queries and anchors', () => {
  for (const destination of ['/', '/dashboard', '/master-resume', '/master-resume?source=jobs&job=123#experience', '/interview-prep', '/admin/prompts', '/recruiter', '/recruiter/dashboard', '/recruiter/requests']) {
